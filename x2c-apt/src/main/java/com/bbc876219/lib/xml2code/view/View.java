...
import com.bbc876219.lib.xml2code.anoprocesser.xml.Style;
...
public class View implements ITranslator {
    ...
    public View(String packageName, String name, Attributes attributes) {
        ...
        this.mImports.add("com.bbc876219.lib.xml2code.X2CUtils");
...
//            if (mTagName.equals("androidx.constraintlayout.widget.ConstraintLayout")
//                    || mTagName.equals("io.bhex.app.bottom.LottieTabLayout")) {
            String paramsName = this.getLayoutParams();
            stringBuilder.append(String.format("%s %s = new %s(%s,%s);\n", paramsName, mLayoutParamsObj
                    , paramsName, width, height));
//            }
        }
